...
🌱 I usually code in `Python`, using Qiskit/PennyLane or PyTorch/TensorFlow for quantum techs and machine learning projects, or Numpy and Scipy for low-level optical applications and Monte Carlo simulations.<br>
...
Below some of the projects I've worked on. See [Repositories](https://github.com/simoneroncallo?tab=repositories) for a complete list. Thanks for reading!
...
|------------|-------------|:-----------:|:-------:| :-------:|
| [Hybrid multinomial classifier](https://github.com/simoneroncallo/hybrid-multinomial-classifier) | Multinomial classifier using quantum binary models | ![PyTorch](https://img.shields.io/badge/-1E1E2F?logo=pytorch&logoColor=EE4C2C) | [![arXiv](https://img.shields.io/badge/-b31b1b.svg?logo=arxiv&logoColor=white)](https://doi.org/10.48550/arXiv.2604.08094) |
| [Quantum stroboscopy](https://github.com/simoneroncallo/quantum-stroboscopy) | Stroboscopic measurements with Monte Carlo | ![SciPy](https://img.shields.io/badge/%20-%20-8CAAE6?logo=scipy&logoColor=white) | [![arXiv](https://img.shields.io/badge/-b31b1b.svg?logo=arxiv&logoColor=white)](https://doi.org/10.48550/arXiv.2507.17740) | ![v0.1.0](https://img.shields.io/badge/v0.1.0-brightgreen)
| [Quantum optical network](https://github.com/simoneroncallo/quantum-optical-network) | Optical neural networks for image classification | ![TensorFlow](https://img.shields.io/badge/%20-%20-FF7A00?logo=tensorflow&logoColor=white) | [![arXiv](https://img.shields.io/badge/-b31b1b.svg?logo=arxiv&logoColor=white)](https://arxiv.org/abs/2507.21036) |
| [Quantum optical neuron](https://github.com/simoneroncallo/quantum-optical-neuron) | Artificial neuron using the Hong-Ou-Mandel effect | ![TensorFlow](https://img.shields.io/badge/%20-%20-FF7A00?logo=tensorflow&logoColor=white) | [![arXiv](https://img.shields.io/badge/-b31b1b.svg?logo=arxiv&logoColor=white)](https://arxiv.org/abs/2404.15266) |
| [Quantum JPEG](https://github.com/simoneroncallo/quantum-jpeg) | Quantum image downsampling and compression | ![Qiskit](https://img.shields.io/badge/%20-%20-6929C4?logo=qiskit&logoColor=white) | [![arXiv](https://img.shields.io/badge/-b31b1b.svg?logo=arxiv&logoColor=white)](https://arxiv.org/abs/2306.09323) |
| [Quantum arrival time](https://github.com/simoneroncallo/quantum-arrival-time) | Numerical arrival time distributions | ![SciPy](https://img.shields.io/badge/%20-%20-8CAAE6?logo=scipy&logoColor=white) | [![arXiv](https://img.shields.io/badge/-b31b1b.svg?logo=arxiv&logoColor=white)](https://arxiv.org/abs/2205.02219) | ![v0.1.0](https://img.shields.io/badge/v0.1.0-brightgreen)

<!-- | [Binary phase estimation](https://github.com/simoneroncallo/binary-phase-estimation) | Binary phase estimation | ![Qiskit](https://img.shields.io/badge/%20-%20-6929C4?logo=qiskit&logoColor=white) ![NumPy](https://img.shields.io/badge/%20-%20-013243?logo=numpy&logoColor=white) | [![arXiv](https://img.shields.io/badge/-b31b1b.svg?logo=arxiv&logoColor=white)](https://arxiv.org/abs/2407.10966) | -->

### 🚀 Personal Projects 
| Repository | Description | Tools | 
|------------|-------------|:-----------:|
| [Hardware telemetry](https://github.com/simoneroncallo/hw-telemetry) | Hardware usage shared via Telegram API for Unix systems | ![Python](https://img.shields.io/badge/-3776AB?logo=python&logoColor=white) ![Docker](https://img.shields.io/badge/-2496ED?logo=docker&logoColor=white) |  
