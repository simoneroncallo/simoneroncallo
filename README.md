...
🌱 I usually code in `Python`, using Qiskit or Keras for quantum and machine learning projects, or Numpy and Scipy for low-level optical applications and Monte Carlo simulations.<br>
