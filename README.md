...
|------------|-------------|:-----------:|:-------:| :-------:|
| [Hybrid multinomial classifier](https://github.com/simoneroncallo/hybrid-multinomial-classifier) | Multinomial classifier using quantum binary models | ![PyTorch](https://img.shields.io/badge/-1E1E2F?logo=pytorch&logoColor=EE4C2C) | |
